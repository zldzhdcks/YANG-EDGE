...
export const TEAM_ALIASES: TeamAliasEntry[] = [
  ...
  {
    displayName: "오스틴 FC",
    originalNames: ["Austin", "Austin FC", "오스틴FC"],
  ...
  {
    displayName: "시카고 파이어",
    originalNames: ["Chicago Fire", "Chicago Fire FC", "시카파이"],
  ...
  },
  {
    ...
    originalNames: ["New York City FC", "NYCFC", "New York City", "뉴욕시티"],
  ...
  },
  {
    ...
    originalNames: ["Philadelphia Union", "필라유니"],
  ...
  },
  {
    ...
    originalNames: ["Portland Timbers", "포틀팀버"],
  ...
  },
  {
    ...
    originalNames: ["Seattle Sounders", "Seattle Sounders FC", "시애사운"],
  ...
  {
    displayName: "아스널",
    originalNames: ["Arsenal", "Arsenal FC", "아스널"],
  ...
  {
    displayName: "맨시티",
    originalNames: ["Manchester City", "Man City", "맨체스C"],
  ...
  {
    displayName: "바르셀로나",
    originalNames: ["Barcelona", "FC Barcelona", "바르셀로"],
  ...
  {
    displayName: "셀타비고",
    originalNames: ["Celta Vigo", "Celta de Vigo", "셀타비고"],
    externalIds: [{ provider: "api-football", id: "538" }],
    league: "라리가",
    sport: "football",
  },
  {
    displayName: "오사수나",
    originalNames: ["Osasuna", "CA Osasuna", "오사수나"],
    externalIds: [{ provider: "api-football", id: "727" }],
    league: "라리가",
    sport: "football",
  },
  {
    displayName: "A빌바오",
    originalNames: ["Athletic Club", "Athletic Bilbao", "A빌바오"],
    externalIds: [{ provider: "api-football", id: "531" }],
    league: "라리가",
    sport: "football",
  },
  {
    displayName: "라싱산탄",
    originalNames: ["Racing Santander", "라싱산탄"],
    externalIds: [{ provider: "api-football", id: "4665" }],
    league: "라리가",
    sport: "football",
  },
  {
    displayName: "엘체",
    originalNames: ["Elche", "엘체"],
    externalIds: [{ provider: "api-football", id: "797" }],
    league: "라리가",
    sport: "football",
  },
  {
    displayName: "알라베스",
    originalNames: ["Alaves", "알라베스"],
    externalIds: [{ provider: "api-football", id: "542" }],
    league: "라리가",
    sport: "football",
  },
  {
    displayName: "비야레알",
    originalNames: ["Villarreal", "비야레알"],
    externalIds: [{ provider: "api-football", id: "533" }],
    league: "라리가",
    sport: "football",
  },
  {
    displayName: "에스파뇰",
    originalNames: ["Espanyol", "에스파뇰"],
    externalIds: [{ provider: "api-football", id: "540" }],
    league: "라리가",
    sport: "football",
  },
  {
    displayName: "레반테",
    originalNames: ["Levante", "레반테"],
    externalIds: [{ provider: "api-football", id: "539" }],
    league: "라리가",
    sport: "football",
  },
  {
  ...
  {
    displayName: "슈투트가",
    originalNames: ["VfB Stuttgart", "슈투트가"],
    externalIds: [{ provider: "api-football", id: "172" }],
    league: "분데스리가",
    sport: "football",
  },
  {
    displayName: "크리스털",
    originalNames: ["Crystal Palace", "크리스털"],
    externalIds: [{ provider: "api-football", id: "52" }],
    league: "프리미어리그",
    sport: "football",
  },
  {
    displayName: "AC밀란",
    originalNames: ["AC Milan", "AC밀란"],
    externalIds: [{ provider: "api-football", id: "489" }],
    league: "세리에 A",
    sport: "football",
  },
  {
    displayName: "베네치아",
    originalNames: ["Venezia", "베네치아"],
    externalIds: [{ provider: "api-football", id: "517" }],
    league: "세리에 A",
    sport: "football",
  },
  {
    displayName: "릴OSC",
    originalNames: ["Lille", "릴OSC"],
    externalIds: [{ provider: "api-football", id: "79" }],
    league: "리그 1",
    sport: "football",
  },
  {
    displayName: "PSG",
    originalNames: ["Paris Saint Germain", "Paris Saint-Germain", "PSG"],
    externalIds: [{ provider: "api-football", id: "85" }],
    league: "리그 1",
    sport: "football",
  },
  {
    displayName: "흐로닝언",
    originalNames: ["Groningen", "흐로닝언"],
    externalIds: [{ provider: "api-football", id: "202" }],
    league: "에레디비시에",
    sport: "football",
  },
  {
    displayName: "F시타르",
    originalNames: ["Fortuna Sittard", "F시타르"],
    externalIds: [{ provider: "api-football", id: "205" }],
    league: "에레디비시에",
    sport: "football",
  },
  {
    displayName: "아약스",
    originalNames: ["Ajax", "아약스"],
    externalIds: [{ provider: "api-football", id: "194" }],
    league: "에레디비시에",
    sport: "football",
  },
  {
    displayName: "헤이렌베",
    originalNames: ["Heerenveen", "헤이렌베"],
    externalIds: [{ provider: "api-football", id: "210" }],
    league: "에레디비시에",
    sport: "football",
  },
  {
    displayName: "렉섬",
    originalNames: ["Wrexham", "렉섬"],
    externalIds: [{ provider: "api-football", id: "1837" }],
    league: "EFL 챔피언십",
    sport: "football",
  },
  {
    displayName: "버밍엄C",
    originalNames: ["Birmingham", "버밍엄C"],
    externalIds: [{ provider: "api-football", id: "54" }],
    league: "EFL 챔피언십",
    sport: "football",
  },
  {
    displayName: "번리",
    originalNames: ["Burnley", "번리"],
    externalIds: [{ provider: "api-football", id: "44" }],
    league: "EFL 챔피언십",
    sport: "football",
  },
  {
    displayName: "웨스트햄",
    originalNames: ["West Ham", "웨스트햄"],
    externalIds: [{ provider: "api-football", id: "48" }],
    league: "EFL 챔피언십",
    sport: "football",
  },
];
