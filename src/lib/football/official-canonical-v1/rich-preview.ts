...
export type RichPreview=ReturnType<typeof buildRichPreview>&{confirmedKeyPlayerIds?:number[];seasonSplit?:{currentSeason:number;previousSeason:number;teams:any[];sourceReportHash:string};previousHash?:string;revisionReason?:string};
