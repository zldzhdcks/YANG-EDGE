...
async function main(){
 ...
 const localDir=join(resolve(root,'..'),'football-v31-r1-third-real-batch-preflight-v1');
 ...
 console.log(JSON.stringify({
  ...
  FIRST_SECOND_BATCH_PERFORMANCE_USED_FOR_TUNING:report.FIRST_SECOND_BATCH_PERFORMANCE_USED_FOR_TUNING,
